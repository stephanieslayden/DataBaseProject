		...
		<div class="row">
			<div class="col-lg-12 col-md-12">
					<table class="table table-hover table-striped table-bordered">
						...
						<tbody>
							<c:forEach items="${ProducerMovie}" var="ProducerMovie">
								<tr>
										<td>${ProducerMovie.title}</td>
										<td>${ProducerMovie.firstName}</td>
<%-- 									<td>${ProducerMovie.year_released}</td>
									<td>${ProducerMovie.rating}</td>
									<td>${ProducerMovie.price}</td> --%>
								</tr>
							</c:forEach>
						</tbody>
				</table>
